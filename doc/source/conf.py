...
# -*- coding: utf-8 -*-
#
# MPD_sima documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'MPD_sima.tex', 'MPD\\_sima Documentation',
   'kaliko', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'MPD_sima', 'MPD_sima Documentation',
   author, 'MPD_sima', 'One line description of project.',
   'Miscellaneous'),
]
